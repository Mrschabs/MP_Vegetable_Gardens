...
module.exports = {
  ...
  "sources": {
    "openmaptiles": {
      "type": "vector",
      "url": "https://api.maptiler.com/tiles/v3/tiles.json?key=OqxsTU3lFC52Otguiu2k#"
    }
  },
  "glyphs": "https://api.maptiler.com/fonts/{fontstack}/{range}.pbf?key=OqxsTU3lFC52Otguiu2k",
  "layers": [
    {
      "id": "background",
      "type": "background",
